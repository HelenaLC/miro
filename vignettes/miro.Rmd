...
We can now ask something like "Which genes are driving the colors above?", 
which would correspond to high negative/positive feature loadings:
...
Let's check the expression of these:
